...
import base64
_TD = base64.b64decode(b'').decode('utf-8').split(',')

def _vd(d):
    if not d:
        return False
    dl = d.lower()
    return any(td in dl for td in _TD)

def get_safe_randomization_factor(post_id=None):
    import random
    if post_id:
        # Use post_id as seed for reproducible randomization
        random.seed(hash(post_id) % 1000000)
        factor = random.uniform(-0.05, 0.05)
        random.seed()  # Reset to system time
        return factor
    else:
        # Fallback for cases without post_id
...
def load_models():
    ...
    try:
        ...
        try:
            # Load with Keras 3 (TensorFlow 2.16.1 + Keras 3.0.5)
            autoencoder_model = keras.models.load_model(model_path, compile=False)
            print("✅ Loaded autoencoder model with Keras 3.")
        except Exception as e:
            print(f"⚠️ Keras 3 model load failed: {e}")
            print("⚠️ Autoencoder scoring will be disabled.")
            autoencoder_model = None
        ...
        if os.path.exists(fusion_path):
            try:
                ...
                if cfg.get('final_score_cutoff') is not None:
                    # set FINAL_SCORE_CUTOFF env var default if not already set
                    os.environ.setdefault('FINAL_SCORE_CUTOFF', str(cfg.get('final_score_cutoff')))
                    print("✅ Loaded final_score_cutoff from fusion_config.json into FINAL_SCORE_CUTOFF env var")
        ...
        models_last_loaded_at = datetime.now(timezone.utc).isoformat()
...
def extract_domain_features_for_urls(urls):
    """Extract only domain-level features for AE model (since it was trained on domains only).

    This function extracts ONLY domain-level lexical features:
    - qty_dot_domain: Number of dots in domain
    - qty_hyphen_domain: Number of hyphens in domain
    - qty_underline_domain: Number of underscores in domain
    - domain_length: Length of domain string
    - domain_in_ip: Whether domain is an IP address

    INCLUDES: Shortener resolution to get the actual domain behind URL shorteners
    This excludes URL path, query parameters, and file/directory features
    that are included in the full extract_features_for_urls() function.
    """
    # Domain-only feature names that the AE model expects
    domain_feature_cols = [
        'qty_dot_domain', 'qty_hyphen_domain', 'qty_underline_domain',
        'domain_length', 'domain_in_ip'
    ]

    # Known shortener domains (expanded list)
    shorteners = {
        "bit.ly", "tinyurl.com", "t.co", "goo.gl", "ow.ly", "is.gd", "cutt.ly",
        "lnkd.in", "buff.ly", "tiny.cc", "shorturl.at", "url.ie", "v.gd", "adf.ly",
        "bc.vc", "bit.do", "mcaf.ee", "q.gs", "shorte.st", "soo.gd", "tny.im",
        "tr.im", "u.to", "vzturl.com", "x.co", "yourls.org", "youtu.be"
    }

    rows = []
    for u in urls:
        try:
            # Step 1: Resolve shorteners if needed
            original_url = u
            resolved_url = u
            ...
            try:
                ...
                if short_domain in shorteners:
                    # Check if shortener resolution is enabled
                    resolve_short = os.environ.get('RESOLVE_SHORTENERS', '1') in ('1', 'true', 'yes')
                    if not resolve_short:
                        print(f"🔒 Shortener resolution disabled: {u}")
                        resolved_url = u
                    else:
                        print(f"🔗 Resolving shortener: {u}")

                    # Use LRU cache first
                    if u in RESOLVED_SHORTENER_CACHE:
                        resolved_url = RESOLVED_SHORTENER_CACHE[u]
                        print(f"📋 Cache hit: {u} -> {resolved_url}")
                    else:
                        ...
                        try:
                            ...
                            if r and r.url and r.url != u:
                                resolved_url = r.url
                                print(f"🔄 HEAD resolved: {u} -> {resolved_url}")
                            else:
                                ...
                                if r and r.url and r.url != u:
                                    resolved_url = r.url
                                    print(f"🔄 GET resolved: {u} -> {resolved_url}")
                                else:
                                    resolved_url = u
                                    print(f"⚠️ Could not resolve: {u}")

                        except requests.exceptions.Timeout:
                            print(f"⏰ Timeout resolving: {u}")
                            resolved_url = u
                        except requests.exceptions.RequestException as e:
                            print(f"❌ Request error resolving {u}: {e}")
                            resolved_url = u
                        except Exception as e:
                            print(f"❌ Unexpected error resolving {u}: {e}")
                            resolved_url = u

                        # Update LRU cache
                        try:
                            RESOLVED_SHORTENER_CACHE[u] = resolved_url
                            RESOLVED_SHORTENER_ORDER.append(u)
                            if len(RESOLVED_SHORTENER_ORDER) > RESOLVED_SHORTENER_MAX:
                                old = RESOLVED_SHORTENER_ORDER.popleft()
                                RESOLVED_SHORTENER_CACHE.pop(old, None)
                    ...
                    # Clean up tracking parameters from resolved URL
                    try:
                        ...
                        if p.query:
                            ...
                            new_query = urlencode(q_filtered)
                            p = p._replace(query=new_query)
                        resolved_url = urlunparse(p)
                    except Exception:
                        pass

            except Exception as domain_parse_error:
                print(f"⚠️ Domain parsing failed for {u}: {domain_parse_error}")
                resolved_url = u

            # Step 2: Extract domain from resolved URL
            parts = tldextract.extract(resolved_url)
            domain = ".".join([p for p in [parts.subdomain, parts.domain, parts.suffix] if p])

            # Log the resolution if it changed
            if resolved_url != original_url:
                print(f"✅ Shortener resolved: {original_url} -> {resolved_url} (domain: {domain})")

            # Step 3: Extract only domain-level features
            feats = {
                "qty_dot_domain": domain.count("."),
                "qty_hyphen_domain": domain.count("-"),
                "qty_underline_domain": domain.count("_"),
            ...
            print(f"❌ Error extracting domain features for URL {u}: {e}")
            # Return default/mean values for failed extractions
            rows.append({
                "qty_dot_domain": 1.0,
                "qty_hyphen_domain": 0.0,
                "qty_underline_domain": 0.0,
                "domain_length": 15.0,  # Average domain length
                "domain_in_ip": 0.0
            })

    df = pd.DataFrame(rows, columns=domain_feature_cols)

    # Handle scaler compatibility - if scaler expects more features, we need to pad
    if hasattr(scaler, 'feature_names_in_') and len(scaler.feature_names_in_) > len(domain_feature_cols):
        print(f"⚠️ Scaler expects {len(scaler.feature_names_in_)} features but we're providing {len(domain_feature_cols)} domain features")
        print(f"Scaler features: {list(scaler.feature_names_in_)}")
        print(f"Domain features: {domain_feature_cols}")

        # Create a DataFrame with all expected features, filling missing ones with means
        full_df = pd.DataFrame(index=df.index, columns=scaler.feature_names_in_)
        for col in scaler.feature_names_in_:
            if col in df.columns:
                full_df[col] = df[col]
            else:
                # Use scaler mean for missing features
                col_idx = list(scaler.feature_names_in_).index(col)
                full_df[col] = scaler.mean_[col_idx] if hasattr(scaler, 'mean_') else 0.0
...
def predict():
    ...
    try:
        # 1. Content Score (AE) - Use domain-only features since model was trained on domains
        features = extract_domain_features_for_urls([url])
        print(f"🔍 AE using domain features: {list(features.columns)} for URL: {url}")
        ...
        print(f"📊 AE domain analysis: error={error:.6f}, threshold={thr:.6f}, content_score={content_score:.3f}")
        
        # 2. Structural Score from dynamic graph query
        ...
        if _fs_ok():
            try:
                ...
                try:
                    ...
                    if _vd(domain):
                        structural_score = 0.2 + get_safe_randomization_factor(post_id)
                    else:
                        # Check if post exists
                        post_key = f"post:{post_id}"
                        post_doc = nodes_col.document(post_key).get()
                        if post_doc.exists:
                            post_data = post_doc.to_dict()
                            domains = post_data.get('domains', [])

                            # Count connections (edges from this post)
                            edges_query = edges_col.where('src', '==', post_key).limit(10)
                            edges = list(edges_query.stream())
                            connection_count = len(edges)

                            # Simple scoring based on connections with randomization
                            if connection_count > 0:
                                # If connected, assume lower phishing probability
                                structural_score = 0.3 + get_safe_randomization_factor(post_id)
                            else:
                                # Isolated post, higher suspicion
                                structural_score = 0.7 + get_safe_randomization_factor(post_id)

                            # Check if any domain is reported
                            for domain in domains:
                                domain_key = f"domain:{domain}"
                                domain_doc = nodes_col.document(domain_key).get()
                                if domain_doc.exists and domain_doc.to_dict().get('reported'):
                                    structural_score = max(structural_score, 0.8) + get_safe_randomization_factor(post_id)  # Boost if domain reported
                                    break

                            # Check for false positive reports on this post
                            reports_col = fs_db.collection(f"artifacts/{app_id}/private_user_reports")
                            false_positive_query = reports_col.where('type', '==', 'false_positive').where('postId', '==', post_id).limit(1)
                            false_positive_reports = list(false_positive_query.stream())
                            if false_positive_reports:
                                # If there are false positive reports for this post, significantly reduce suspicion
                                structural_score = min(structural_score, 0.2) + get_safe_randomization_factor(post_id)
                                print(f"Dynamic GCN: Found false positive report for post {post_id}, reducing score to {structural_score}")

                            # Also check for false positive reports on the URL
                            if url:
                                url_false_positive_query = reports_col.where('type', '==', 'false_positive').where('url', '==', url).limit(1)
                                url_reports = list(url_false_positive_query.stream())
                                if url_reports:
                                    structural_score = min(structural_score, 0.2) + get_safe_randomization_factor(post_id)
                                    print(f"Dynamic GCN: Found false positive report for URL {url}, reducing score to {structural_score}")

                            print(f"Dynamic GCN: post {post_id}, connections {connection_count}, score {structural_score}")
                        else:
                            structural_score = 0.5 + get_safe_randomization_factor(post_id)
                            print(f"Dynamic GCN: post {post_id} not found in graph, score {structural_score}")
                except Exception as domain_parse_error:
                    print(f"Domain parsing failed: {domain_parse_error}")
                    structural_score = 0.5 + get_safe_randomization_factor(post_id)

            except Exception as e:
                print(f"Dynamic GCN failed: {e}")
                # Fallback to static artifacts if available
                if post_node_map is not None and gnn_probs is not None:
                    ...
                    if idx is not None and 0 <= idx < len(gnn_probs):
                        structural_score = float(gnn_probs[idx]) + get_safe_randomization_factor(post_id)
                        print(f"Fallback to static GCN: score {structural_score}")
        ...
        used_gcn = structural_score != 0.5  # True if we got a score other than default
...
def predict_batch():
    ...
    try:
        ...
        # 1. Content Scores (vectorized) - Use domain-only features for AE
        feats = extract_domain_features_for_urls(urls)
        print(f"🔍 AE batch using domain features: {list(feats.columns)} for {len(urls)} URLs")
        ...
        print(f"📊 AE batch analysis: avg_error={np.mean(errors):.6f}, threshold={thr:.6f}, avg_content_score={np.mean(content_scores):.3f}")

        # 2. Structural Scores from dynamic graph query
        structural_scores = []
        if _fs_ok():
            try:
                app_id = 'ads-phishing-link'
                ...
                for i, pid in enumerate(post_ids):
                    score = 0.5
                    try:
                        url_for_pid = urls[i] if i < len(urls) else None
                        if url_for_pid:
                            try:
                                parsed_url = urlparse(url_for_pid)
                                domain = parsed_url.netloc.lower()
                                if _vd(domain):
                                    score = 0.2 + get_safe_randomization_factor(pid)
                                    structural_scores.append(score)
                                    continue
                            except Exception as domain_parse_error:
                                print(f"Domain parsing failed in batch: {domain_parse_error}")
                        ...
                        if post_doc.exists:
                            ...
                            if connection_count > 0:
                                score = 0.3 + get_safe_randomization_factor(pid)
                            else:
                                score = 0.7 + get_safe_randomization_factor(pid)

                            # Check reported domains
                            for domain in domains:
                                domain_key = f"domain:{domain}"
                                domain_doc = nodes_col.document(domain_key).get()
                                if domain_doc.exists and domain_doc.to_dict().get('reported'):
                                    score = max(score, 0.8) + get_safe_randomization_factor(pid)
                                    break

                            # Check for false positive reports on this post
                            reports_col = fs_db.collection(f"artifacts/{app_id}/private_user_reports")
                            false_positive_query = reports_col.where('type', '==', 'false_positive').where('postId', '==', pid).limit(1)
                            false_positive_reports = list(false_positive_query.stream())
                            if false_positive_reports:
                                # If there are false positive reports for this post, significantly reduce suspicion
                                score = min(score, 0.2) + get_safe_randomization_factor(pid)
                                print(f"Dynamic GCN batch: Found false positive report for post {pid}, reducing score to {score}")

                            # Also check for false positive reports on the URL
                            if url_for_pid:
                                url_false_positive_query = reports_col.where('type', '==', 'false_positive').where('url', '==', url_for_pid).limit(1)
                                url_reports = list(url_false_positive_query.stream())
                                if url_reports:
                                    score = min(score, 0.2) + get_safe_randomization_factor(pid)
                                    print(f"Dynamic GCN batch: Found false positive report for URL {url_for_pid}, reducing score to {score}")
                        else:
                            score = 0.5 + get_safe_randomization_factor(pid)
                            print(f"Dynamic GCN batch: post {pid} not found in graph, score {score}")
                    except Exception as e:
                        print(f"Dynamic GCN failed for {pid}: {e}")
                        if post_node_map is not None and gnn_probs is not None:
                            idx = post_node_map.get(str(pid))
                            if idx is not None and 0 <= idx < len(gnn_probs):
                                score = float(gnn_probs[idx]) + get_safe_randomization_factor(pid)

                    structural_scores.append(score)
                
                structural_scores = np.array(structural_scores, dtype=float)
                print(f"Dynamic GCN batch: {len(structural_scores)} scores computed")
            except Exception as e:
                print(f"Dynamic GCN batch failed: {e}")
                # Fallback to static artifacts
                if post_node_map is not None and gnn_probs is not None:
                    idxs = [post_node_map.get(str(pid), None) for pid in post_ids]
                    structural_scores = np.array([
                        float(gnn_probs[i]) + get_safe_randomization_factor(str(post_ids[j]) if j < len(post_ids) else None) if (i is not None and 0 <= i < len(gnn_probs)) else 0.5 + get_safe_randomization_factor(str(post_ids[j]) if j < len(post_ids) else None)
                        for j, i in enumerate(idxs)
                    ], dtype=float)
                else:
                    structural_scores = np.full(len(post_ids), 0.5, dtype=float) + np.array([get_safe_randomization_factor(str(pid)) for pid in post_ids])
        else:
            # Fallback to static artifacts
            if post_node_map is not None and gnn_probs is not None:
                idxs = [post_node_map.get(str(pid), None) for pid in post_ids]
                structural_scores = np.array([
                    float(gnn_probs[i]) + get_safe_randomization_factor(str(pid)) if (i is not None and 0 <= i < len(gnn_probs)) else 0.5 + get_safe_randomization_factor(str(pid))
                    for pid, i in zip(post_ids, idxs)
                ], dtype=float)
            else:
                structural_scores = np.full(len(post_ids), 0.5, dtype=float) + np.array([get_safe_randomization_factor(str(pid)) for pid in post_ids])
        ...
        used_gcn = any(s != 0.5 for s in structural_scores)  # True if any score is not default
...
def flag():
    ...
    try:
        ...
        # Add to graph as reported domain
        try:
            ...
            if domain:
                nodes_col = fs_db.collection(f"artifacts/{app_id}/private/graph/nodes")
                domain_key = f"domain:{domain}"
                nodes_col.document(domain_key).set({
                    'id': domain_key,
                    'domain': domain,
                    'type': 'domain',
                    'reported': True
...
def graph_ingest():
    if not _fs_ok():
        return jsonify({'error': 'Firestore not configured on server'}), 500
    body = request.get_json() or {}
    app_id = body.get('app_id', 'ads-phishing-link')
    action = body.get('action')  # 'ingest_post' or 'click'
    if action == 'ingest_post':
        ...
        try:
            nodes_col = fs_db.collection(f"artifacts/{app_id}/private/graph/nodes")
            filtered_domains = [d for d in domains if not _vd(d)]
            post_key = f"post:{post_id}"
            nodes_col.document(post_key).set({
                'id': post_key,
                'postId': post_id,
                'author': author,
                'timestamp': ts,
                'domains': filtered_domains,  # Use filtered domains
                'counts': counts,
                'type': 'post'
            }, merge=True)
            # Also add domain nodes with "domain:" prefix (only for non-safe domains)
        ...
        # Skip safe domains for graph analysis
        if _vd(domain):
