...
if (typeof processedPostIds === 'undefined') {
    var processedPostIds = new Set();
}
...
function extractPostContent(postElement) {
    ...
    if (!postElement) return { text: '', links: [] };
...
if (typeof scanDebounceHandle === 'undefined') {
    var scanDebounceHandle = null;
}
...
if (typeof graphClickListenerAdded === 'undefined') {
    var graphClickListenerAdded = false;
}
